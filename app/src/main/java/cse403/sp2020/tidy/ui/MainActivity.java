...
public class MainActivity extends AppCompatActivity {
      ...
      public void onEvent(@Nullable QuerySnapshot snapshot, @Nullable FirebaseFirestoreException e) {
        ...
        if (snapshot != null) {
          if (snapshot.isEmpty() && snapshot.getDocuments().isEmpty()) {
            ...
            Log.d(TAG, "Users Collection has " + snapshot.getDocuments().size() + " documents ");
  ...
  private void getAllTasks() {
    ...
    AllTasks.addSnapshotListener(new EventListener<QuerySnapshot>() {
      @Override
      public void onEvent(@Nullable QuerySnapshot snapshot, @Nullable FirebaseFirestoreException e) {
        if (e != null) {
        ...
        if (snapshot != null) {
          if (snapshot.isEmpty() && snapshot.getDocuments().isEmpty()) {
            ...
            Log.d(TAG, "Tasks Collection has " + snapshot.getDocuments().size() + " documents ");
            for (DocumentSnapshot d : snapshot.getDocuments()) {
              Log.d(TAG, "Found Task Collection Document: " + d.getId() + ", data: " + d.getData());
              getTask(d.getId());
            }
          }
        } else {
  ...
  private void getTask(final String documentID) {
    ...
    task.addSnapshotListener(new EventListener<DocumentSnapshot>() {
      @Override
  ...
  private void getHouseHoldID(FirebaseUser user) {
    ...
    houseHoldIDQuery.addSnapshotListener(new EventListener<QuerySnapshot>() {
      @Override
